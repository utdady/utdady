...
plt.hlines(y=np.arange(1,21),xmin=0,xmax=standings['PTS'],color=teamColours)
plt.plot(standings['PTS'],np.arange(1,21),"o")
plt.title("Premier League 16/17")
plt.yticks(np.arange(1,21),standings['TEAM'])
plt.ylabel("Team")
plt.xlabel("Points")
plt.show()
