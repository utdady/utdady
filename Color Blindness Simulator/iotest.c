...
int main(int argc, char **argv) {
    ...
    // =============================================================================================
    // now you should test your write functions
    // you can use ftruncate to remove data that was written to the file by previous tests (i.e.
    // ftruncate(fd, 0). then, open filename for writing, use some of your functions to write to it,
    // and then read from the file using fd and make sure the data that was read is what it should
    // be based on what you wrote. follow the TEST() statements above for guidance.
    //
    // since the file is buffered, you'll have to use write_close before these tests since otherwise
    // no data will actually get written (it'll just be in the buffer). if you want to be extra
    // cool, you could even *make sure* that no data has been written before you close the file!
    // =============================================================================================
